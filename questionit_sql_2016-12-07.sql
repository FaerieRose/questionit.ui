INSERT INTO `student` (`id`, `email`, `first_name`, `valid`, `last_name`, `password`) VALUES (NULL, 'rvandemaat@hotmail.com', 'Rik', b'1', 'van de Maat', 'test123');
INSERT INTO `student` (`id`, `email`, `first_name`, `valid`, `last_name`, `password`) VALUES (NULL, 'm.medendorp@gmail.com', 'Marcel', b'1', 'Medendorp', 'test234');
INSERT INTO `student` (`id`, `email`, `first_name`, `valid`, `last_name`, `password`) VALUES (NULL, 'remond.karst@gmail.com', 'Remond', b'1', 'Karst', 'test345');
INSERT INTO `student` (`id`, `email`, `first_name`, `valid`, `last_name`, `password`) VALUES (NULL, 's.martens.ehv@gmail.com', 'Stefan', b'1', 'Martens', 'test345');
INSERT INTO `student` (`id`, `email`, `first_name`, `valid`, `last_name`, `password`) VALUES (NULL, 'schave76@gmail.com', 'Dave', b'1', 'Schellekens', 'test345');
INSERT INTO `instructor` (`id`, `email`, `first_name`, `valid`, `last_name`, `password`) VALUES (NULL, 'rosalynn.hardy@gmail.com', 'Rosalynn', b'1', 'Hardy', 'test987');
INSERT INTO `instructor` (`id`, `email`, `first_name`, `valid`, `last_name`, `password`) VALUES (NULL, 'digitaleservice@gmail.com', 'Felix', b'1', 'van Loenen', 'test876');
INSERT INTO `instructor` (`id`, `email`, `first_name`, `valid`, `last_name`, `password`) VALUES (NULL, 'bas.smulders@gmail.com', 'Bas', b'1', 'Smulders', 'test876');
...
INSERT INTO `question` (`id`, `creation_date_time`, `for_exam`, `enabled`, `name`, `programming_language`, `explanation_answer`, `is_obsolete`, `question`, `type_of_question`, `creator_id`, `correct_answers_id`) VALUES (NULL, '2016-11-15 9:15:32', '1', b'1', 'Testing for loop', '1', 'Yes, the for loop is correct!', b'0', 'Is the following statement correct?
<pre>
  for (int a = 0; a < 10; a++)
    a = a * a;
  }
...
INSERT INTO `question` (`id`, `creation_date_time`, `for_exam`, `enabled`, `name`, `programming_language`, `explanation_answer`, `is_obsolete`, `question`, `type_of_question`, `creator_id`, `correct_answers_id`) VALUES (NULL, '2016-11-15 9:17:32', '3', b'1', 'If in for', '2', 'Yes, correct!', b'0', 'Is the following statement correct?
<pre>
  for (int a = 0; a < 10; a++)
    if (a * a > 10) {
	    break;
...
INSERT INTO `test_template` (`id`, `creation_date_time`, `for_exam`, `enabled`, `name`, `programming_language`, `attempt_time_in_minutes`, `creator_id`) VALUES (NULL, '2016-11-15 9:25:32', '1', b'1', 'First OCA exam', '1', '120', '1');
INSERT INTO `test_template` (`id`, `creation_date_time`, `for_exam`, `enabled`, `name`, `programming_language`, `attempt_time_in_minutes`, `creator_id`) VALUES (NULL, '2016-11-15 9:35:32', '1', b'1', 'Sceond OCA exam', '1', '120', '2');
